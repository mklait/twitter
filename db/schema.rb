...
ActiveRecord::Schema.define(version: 20171205132712) do
  ...
  create_table "tweeters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_tweeters_on_email", unique: true
    t.index ["reset_password_token"], name: "index_tweeters_on_reset_password_token", unique: true
  end
